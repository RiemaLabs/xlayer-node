...
// the main data structure used in the Nubit DA network:
...
type Listener struct {
	...
	hashBroadcaster   p2psub.BroadcastFn
...
func (cl *Listener) handleNewSignedBlock(ctx context.Context, b types.EventDataSignedBlock) error {
	...
	eds, err := extendBlock(b.Data, b.Header.Version.App, kzg.NodeVisitor(adder.VisitFn()))
	if err != nil {
	...
	if !syncing {
		err = cl.hashBroadcaster(ctx, p2psub.Notification{
