...
import (
	...
	pb "github.com/riemalabs/nubit-node/p2p/p2peds/pb"
)

// Client is responsible for requesting EDSs for blocksync over the P2P/EDS protocol.
type Client struct {
	params     *Parameters
...
// NewClient creates a new P2P/EDS client.
func NewClient(params *Parameters, host host.Host) (*Client, error) {
	if err := params.Validate(); err != nil {
		return nil, fmt.Errorf("p2p-eds: client creation failed: %w", err)
	}
