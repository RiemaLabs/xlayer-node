...
type Module interface {
	...
	GetHeightRangeAtBtcHeight(ctx context.Context, btcHeight uint64) ([]*header.ExtendedHeader, error)
	GetBtcHeight(ctx context.Context, nubitHeight uint64) (uint64, error)
}
...
type API struct {
	Internal struct {
		...
		GetHeightRangeAtBtcHeight func(ctx context.Context, btcHeight uint64) ([]*header.ExtendedHeader, error) `perm:"read"`
		GetBtcHeight              func(ctx context.Context, nubitHeight uint64) (uint64, error)                 `perm:"read"`
	}
}
...
func (api *API) GetHeightRangeAtBtcHeight(ctx context.Context, btcHeight uint64) ([]*header.ExtendedHeader, error) {
	return api.Internal.GetHeightRangeAtBtcHeight(ctx, btcHeight)
}

func (api *API) GetBtcHeight(ctx context.Context, nubitHeight uint64) (uint64, error) {
	return api.Internal.GetBtcHeight(ctx, nubitHeight)
}
