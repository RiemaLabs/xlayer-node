...
func (bankModule) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	metadata := banktypes.Metadata{
		Description: "The native token of the Nubit network.",
		Base:        BondDenom,
		Name:        DisplayDenom,
...
func (govModule) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	...
	genState.DepositParams.MinDeposit = sdk.NewCoins(sdk.NewCoin(BondDenom, sdk.NewInt(10_000_000_000))) // 10,000 NUB
...
func DefaultConsensusConfig() *tmcfg.Config {
	...
	// TODO: make TimeoutBroadcastTx configurable per https://github.com/riemalabs/nubit-app/issues/1034
