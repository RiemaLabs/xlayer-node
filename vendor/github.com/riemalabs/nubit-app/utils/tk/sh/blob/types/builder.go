...
// KeyringSigner uses a keyring to sign and build nubit-app transactions
...
// NewTxBuilder returns the default sdk Tx builder using the nubit-app encoding config
...
// QueryAccount fetches the account number and sequence number from the nubit-app node.
