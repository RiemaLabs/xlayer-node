...
// the previous blob.
//
// See https://github.com/riemalabs/nubit-app/blob/main/specs/src/specs/data_square_layout.md
...
// in ADR013
// (nubit-app/docs/architecture/adr-013-non-interative-default-rules-for-zero-padding).
