...
import (
	...
	"github.com/RiemaLabs/nubit-validator/test/util/testnode"
)

// DefaultTestConfig returns the default testing configuration for Tendermint + Nubit App tandem.
//
...
//
// Additionally, it instructs Tendermint + Nubit App tandem to setup 10 funded accounts.
...
// StartTestNode simply starts Tendermint and Nubit App tandem with default testing
// configuration.
func StartTestNode(t *testing.T) testnode.Context {
	return StartTestNodeWithConfig(t, DefaultTestConfig())
}

// StartTestNodeWithConfig starts Tendermint and Nubit App tandem with custom configuration.
