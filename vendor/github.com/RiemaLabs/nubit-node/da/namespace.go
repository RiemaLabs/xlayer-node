...
var (
	...
	SubmitBlobPaymentNamespace             = Namespace(appns.SubmitBlobPaymentNamespace.Bytes())
...
// NOTE: Once https://github.com/RiemaLabs/nubit-kzg/issues/206 is closed Namespace should become NNT's
// type.
