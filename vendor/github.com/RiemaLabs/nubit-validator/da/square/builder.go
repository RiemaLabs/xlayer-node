...
func (b *Builder) Export() (Square, error) {
	...
	pfbWriter := shares.NewCompactShareSplitter(namespace.SubmitBlobPaymentNamespace, appconsts.ShareVersionZero)
...
// TODO: nubit-core should provide this method for `Blob`s
