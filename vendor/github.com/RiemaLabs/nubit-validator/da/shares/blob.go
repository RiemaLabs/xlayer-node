...
// the previous blob.
//
// See https://github.com/RiemaLabs/nubit-validator/blob/main/specs/src/specs/data_square_layout.md
...
// in ADR013
// (nubit-validator/docs/architecture/adr-013-non-interative-default-rules-for-zero-padding).
