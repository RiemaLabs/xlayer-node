...
import (
	...
	appns "github.com/RiemaLabs/nubit-validator/da/namespace"
	appshares "github.com/RiemaLabs/nubit-validator/da/shares"
...
const (
	URLMsgSubmitBlobPayments = "/nubit.blob.v1.MsgSubmitBlobPayments"
...
// MsgSubmitBlobPayments implements the `LegacyMsg` interface.
...
var _ legacytx.LegacyMsg = &MsgSubmitBlobPayments{}

func NewMsgSubmitBlobPayments(signer string, blobs ...*Blob) (*MsgSubmitBlobPayments, error) {
...
func (msg *MsgSubmitBlobPayments) Route() string { return RouterKey }

// Type fulfills the legacytx.LegacyMsg interface
func (msg *MsgSubmitBlobPayments) Type() string {
	return URLMsgSubmitBlobPayments
}
...
func (msg *MsgSubmitBlobPayments) ValidateBasic() error {
...
func (msg *MsgSubmitBlobPayments) Gas(gasPerByte uint32) uint64 {
...
func (msg *MsgSubmitBlobPayments) GetSignBytes() []byte {
	return sdk.MustSortJSON(ModuleCdc.MustMarshalJSON(msg))
}

// GetSigners fulfills the sdk.Msg interface by returning the signer's address
func (msg *MsgSubmitBlobPayments) GetSigners() []sdk.AccAddress {
...
func CreateCommitment(blob *Blob) ([]byte, error) {
	...
	for i, set := range leafSets {
		...
		tree := kzg.New(sha256.New(), kzg.NamespaceIDSize(appns.NamespaceSize))
