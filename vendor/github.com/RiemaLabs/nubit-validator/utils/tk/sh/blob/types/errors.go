...
var (
	...
	ErrBlobSizeMismatch               = errors.Register(ModuleName, 11113, "actual blob size differs from that specified in the MsgSubmitBlobPayment")
	...
	ErrMismatchedNumberOfPFBorBlob    = errors.Register(ModuleName, 11125, "mismatched number of blobs per MsgSubmitBlobPayment")
	ErrNoPFB                          = errors.Register(ModuleName, 11126, "no MsgSubmitBlobPayments found in blob transaction")
	ErrNamespaceMismatch              = errors.Register(ModuleName, 11127, "namespace of blob and its respective MsgSubmitBlobPayments differ")
	...
	ErrMismatchedNumberOfPFBComponent = errors.Register(ModuleName, 11130, "number of each component in a MsgSubmitBlobPayments must be identical")
