...
// KeyringSigner uses a keyring to sign and build nubit-validator transactions
...
// NewTxBuilder returns the default sdk Tx builder using the nubit-validator encoding config
...
// QueryAccount fetches the account number and sequence number from the nubit-validator node.
