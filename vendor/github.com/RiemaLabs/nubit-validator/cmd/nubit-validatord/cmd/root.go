...
import (
	...
	app "github.com/RiemaLabs/nubit-validator/tx"
...
// NewRootCmd creates a new root command for nubit-validatord. It is called once in the
// main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "nubit-validatord",
		Short: "Start nubit app",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			// Override the default tendermint config for nubit-validator
			var (
...
func queryCommand() *cobra.Command {
	...
	cmd.AddCommand(
		...
		authcmd.QueryTxCmd(),
		app.BtcHeightCommand(),
		app.FindHeightRangeAtBtcHeightCommand(),
	)
