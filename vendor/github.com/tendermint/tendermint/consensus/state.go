...
func (cs *State) defaultDoPrevote(height int64, round int32) {
	...
	stateMachineValidBlock, err := cs.blockExec.ProcessProposal(cs.ProposalBlock, false)
	if err != nil {
...
func (cs *State) defaultSetProposal(proposal *types.Proposal) error {
	...
	cs.Logger.Info("received proposal", "proposer", pubKey.Address())
	cs.Logger.Debug("received proposal", "proposal", proposal, "proposer", pubKey.Address())
	return nil
}
